...
namespace MovieTheaterApp.API.Migrations
{
    ...
    partial class AddReviews
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MovieTheaterApp.API.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MovieTheaterApp.API.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MovieTheaterApp.API.Entities.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MovieTheaterApp.API.Entities.Review", b =>
                {
                    ...
                    b.HasOne("MovieTheaterApp.API.Entities.User", "User")
                        .WithMany("Reviews")
                        .HasForeignKey("UserId");
                });
        }
